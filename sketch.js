...
function Recetpage(){
  ...
  for(i = 0; i < 10; i++ ){
    ...
    breaks[i].color = color(45,145,195);
...
function draw() {
  ...
  plate.move();
  fill(255, 0, 0)
  newArray[0] = ellipse(randomX,randomY,extraRad,extraRad);
